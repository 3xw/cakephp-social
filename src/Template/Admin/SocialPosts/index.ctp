                ...
                <tr id="<?= $socialPost->provider.'-'.$socialPost->id ?>">
                  <td>
                    ...
                    <? if($socialPost->display): ?>
                      <?= $this->Form->postLink($this->Html->tag('i','done',['class' => 'material-icons text-success']),array_merge($link,[0]),['escape' => false]) ?>
                    <? else: ?>
                      <?= $this->Form->postLink($this->Html->tag('i','cancel',['class' => 'material-icons text-danger']),array_merge($link,[1]),['escape' => false]) ?>
                    <? endif; ?>
                  </td>
